...
var FeatureData = struct {
	ControlPlane  feature.DataDefinition[dsccomponentv1alpha1.DSCComponentSpec, infrav1.ControlPlaneSpec]
	Authorization AuthorizationData
}{
	ControlPlane: feature.DataDefinition[dsccomponentv1alpha1.DSCComponentSpec, infrav1.ControlPlaneSpec]{
		Define: func(source *dsccomponentv1alpha1.DSCComponentSpec) feature.DataEntry[infrav1.ControlPlaneSpec] {
