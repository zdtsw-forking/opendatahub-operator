...
func (in *Components) DeepCopyInto(out *Components) {
	*out = *in
	...
	if in.ModelRegistry != nil {
		...
		*out = new(modelregistry.ModelRegistry)
		(*in).DeepCopyInto(*out)
	}
}
