...
func (in *DSCISpec) DeepCopyInto(out *DSCISpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DSCISpec.
func (in *DSCISpec) DeepCopy() *DSCISpec {
	if in == nil {
		return nil
	}
	out := new(DSCISpec)
