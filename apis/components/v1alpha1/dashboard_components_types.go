...
// +kubebuilder:resource:scope=Cluster,shortName=dscdashboard
...
type DSCDashboard struct {
	...
	Spec   DashboardComponentSpec   `json:"spec,omitempty"`
	Status DashboardComponentStatus `json:"status,omitempty"`
}
...
// DashboardComponentStatus defines the custom status of DSCCodeFlare.
