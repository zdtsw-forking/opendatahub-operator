...
// +kubebuilder:resource:scope=Cluster,shortName=dsckueue
...
type DSCKueue struct {
	...
	Spec   KueueComponentSpec   `json:"spec,omitempty"`
	Status KueueComponentStatus `json:"status,omitempty"`
}
...
// KueueComponentStatus defines the custom status of DSCCodeFlare.
