...
// DSCComponentStatus defines the custom status of DSCComponentSpec.
type DSCComponentStatus struct {
...
type DevFlags struct {
	DSCILoggerMode string      `json:"dsciloggermode,omitempty"` // dsciv1.DevFlags
