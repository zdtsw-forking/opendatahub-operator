...
// +kubebuilder:resource:scope=Cluster,shortName=dscmodelmesh
...
type DSCModelMeshServing struct {
	...
	Spec   ModelMeshServingComponentSpec   `json:"spec,omitempty"`
	Status ModelMeshServingComponentStatus `json:"status,omitempty"`
}
...
// ModelMeshServingComponentStatus defines the custom status of DSCCodeFlare.
type ModelMeshServingComponentStatus struct {
