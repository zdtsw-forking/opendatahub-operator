...
// +kubebuilder:resource:scope=Cluster,shortName=dscto
...
type DSCTO struct {
	...
	Spec   KFTOComponentSpec   `json:"spec,omitempty"`
	Status KFTOComponentStatus `json:"status,omitempty"`
}
...
// KFTOComponentStatus defines the custom status of DSCCodeFlare.
