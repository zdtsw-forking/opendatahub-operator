...
const (
	...
	dsciCreationTimeout      = 20 * time.Second // time required to get a DSCI in Ready state
	dscCreationTimeout       = 20 * time.Second // time required to wait till DSC in Ready state
