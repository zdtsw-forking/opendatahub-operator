...
func (k *KserveReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&dsccomponentv1alpha1.DSCKserve{}).
...
func (k *KserveReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	obj := &dsccomponentv1alpha1.DSCKserve{}
	...
	if err != nil {
		if k8serr.IsNotFound(err) || obj.GetDeletionTimestamp() != nil {
			...
			if err = k.ReconcileComponent(ctx, k.Client, k.Log, obj, obj.Spec.DSCComponentSpec, true); err != nil {
	...
	ReconcileComponent(ctx, k.Client, k.Log, obj, obj.Spec.DSCComponentSpec, true)
}
