...
func (r *RayReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&dsccomponentv1alpha1.DSCRay{}).
		Owns(&corev1.Secret{}).
		Owns(
...
func (r *RayReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	obj := &dsccomponentv1alpha1.DSCRay{}
	...
	if err != nil {
		if k8serr.IsNotFound(err) || obj.GetDeletionTimestamp() != nil {
			...
			if err = ReconcileComponent(ctx, r.Client, r.Log, obj, obj.Spec.DSCComponentSpec, true); err != nil {
	...
	ReconcileComponent(ctx, r.Client, r.Log, obj, obj.Spec.DSCComponentSpec, true)
}
