...
func (r *RayReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		if k8serr.IsNotFound(err) || obj.GetDeletionTimestamp() != nil {
			...
			if err = ReconcileComponent(ctx, r.Client, r.Log, obj, obj.Spec.ComponentSpec, true); err != nil {
	...
	ReconcileComponent(ctx, r.Client, r.Log, obj, obj.Spec.ComponentSpec, true)
}
