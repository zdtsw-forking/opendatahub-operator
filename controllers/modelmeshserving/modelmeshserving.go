...
func (m *ModelMeshServingReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&dsccomponentv1alpha1.DSCModelMeshServing{}).
...
func (m *ModelMeshServingReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	obj := &dsccomponentv1alpha1.DSCModelMeshServing{}
	...
	if err != nil {
		if k8serr.IsNotFound(err) || obj.GetDeletionTimestamp() != nil {
			...
			if err = ReconcileComponent(ctx, m.Client, m.Log, obj, obj.Spec.DSCComponentSpec, true); err != nil {
	...
	ReconcileComponent(ctx, m.Client, m.Log, obj, obj.Spec.DSCComponentSpec, true)
}
