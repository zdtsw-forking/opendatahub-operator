...
func (w *WorkbenchReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&dsccomponentv1alpha1.DSCWorkbench{}).
...
func (w *WorkbenchReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	obj := &dsccomponentv1alpha1.DSCWorkbench{}
	...
	if err != nil {
		if k8serr.IsNotFound(err) || obj.GetDeletionTimestamp() != nil {
			...
			if err = ReconcileComponent(ctx, w.Client, w.Log, obj, obj.Spec.DSCComponentSpec, true); err != nil {
	...
	ReconcileComponent(ctx, w.Client, w.Log, obj, obj.Spec.DSCComponentSpec, true)
}
