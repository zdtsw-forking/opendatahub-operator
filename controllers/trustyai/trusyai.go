...
func (t *TrustyAIReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&dsccomponentv1alpha1.DSCTrustyAI{}).
		Owns(&corev1.Secret{}).
		Owns(
...
func (t *TrustyAIReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	obj := &dsccomponentv1alpha1.DSCTrustyAI{}
	...
	if err != nil {
		if k8serr.IsNotFound(err) || obj.GetDeletionTimestamp() != nil {
			...
			if err = ReconcileComponent(ctx, t.Client, t.Log, obj, obj.Spec.DSCComponentSpec, true); err != nil {
	...
	ReconcileComponent(ctx, t.Client, t.Log, obj, obj.Spec.DSCComponentSpec, true)
}
