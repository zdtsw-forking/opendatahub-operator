...
func (d *DashboardReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&dsccomponentv1alpha1.DSCDashboard{}).
		Owns(&corev1.Secret{}).
		Owns(
...
func (d *DashboardReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	obj := &dsccomponentv1alpha1.DSCDashboard{}
	...
	ReconcileComponent(ctx, d.Client, d.Log, obj, obj.Spec.DSCComponentSpec, installedComponentValue)
}
