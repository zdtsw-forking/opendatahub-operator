...
func newComponentLogger(logger logr.Logger, component string, componentSpec *dsccomponentv1alpha1.DSCComponentSpec) logr.Logger {
	mode := ""
	if componentSpec.ComponentDevFlags.DSCILoggerMode != nil {
		mode = componentSpec.ComponentDevFlags.DSCILoggerMode
	}
